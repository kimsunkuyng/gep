    ...
    <div class="container py-5">
        <div>
          <div class="d-flex flex-column text-left mb-3">
            <h1 class="mb-3">12월 온라인 수업 목공 수업</h1>
            <div class="d-flex">
          ...
          <div class="mb-5">
            <img class="img-fluid rounded w-100 mb-4" src="../assets/img/activityIntroduceDetail/activityIntroduceDetail01.jpg" alt="Image"/>
            <p>
              1. 나무상자 만들기 <br>
          ...
          <div class="mb-5">
            ...
            <div class="media mb-4">
              <div class="media-body">
                <h6>
                  김선경 <small><i>2021.12.20 17:56</i></small>
                </h6>
                <p>
                  온라인 목공 수업 좋아요!!
                </p>
            ...
            <div class="media mb-4">
              <div class="media-body">
                <h6>
                  GEP <small><i>2021.12.20 17:12</i></small>
                </h6>
                <p>
                  코로나로 인해 온라인 수업을 진행했습니다
                </p>
                <button class="btn btn-sm btn-light">댓글 삭제 </button>
                <button class="btn btn-sm btn-light">댓글 수정 </button>
              </div>
